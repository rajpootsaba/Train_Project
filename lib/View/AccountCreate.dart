...
import 'package:trainticketapp/View/LoginScreen.dart';
                      ...
                      children: [
                        TextFormField(
                          decoration: InputDecoration(
                            prefixIcon: Icon(Icons.person_2_outlined, color: Color(0xFF015768),),
                            labelText: "Full Name",
                            ...
                            children: [
                              RichText(text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(text: "Login", style: TextStyle(color: Color(0xFF015768))),
                                ]
                              ))
                            ],
                          ),
